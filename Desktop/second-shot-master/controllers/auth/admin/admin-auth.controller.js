...
import { adminsignUpSchema, forgetPasswordSchema, loginSchema, registerPhoneSchema, resendOTPPhoneSchema, resendOTPSchema, resetPasswordSchema, signUpSchema, socialSchema, verifyOTPPhoneSchema, verifyOTPSchema, verifyRegisteredOtpSchema, verifyUserSchema } from "../../../validators/auth-validations.js";
  ...
  try {
    ...
    if (error) {
      ...
      if (!otpRecord) {
        ...
        otpRecord = await OTP.create({ email, otp: 0 });
      }
      ...
      // Send SMS with OTP
      await sendEmail(email,admin.name, otpCode);
